  ...
  space: {
    ...
    node: {
      ...
      ageStops: [
        ...
        { maxHours: 504, bg: "#1f1f33", border: "#323249", shadow: "#2b2b3f", text: "#e5e7eb" },
        { maxHours: 840, bg: "#2a2a3f", border: "#3d3d57", shadow: "#242436", text: "#d1d5db" },
      ],
      flippedBg: "#1a1a2e",
      flippedText: "#e0e0e0",
    },
  ...
  paper: {
    ...
    node: {
      ...
      ageStops: [
        ...
        { maxHours: 504, bg: "#e2e8f0", border: "#cdcdcd", shadow: "#d1d5db", text: "#374151" },
        { maxHours: 840, bg: "#cbd5e1", border: "#9ca3af", shadow: "#cbd5e1", text: "#374151" },
      ],
      flippedBg: "#f9fafb",
      flippedText: "#0f172a",
    },
  ...
  paperDark: {
    ...
    node: {
      ...
      ageStops: [
        ...
        { maxHours: 504, bg: "#374151", border: "#4b5563", shadow: "#4b5563", text: "#e5e7eb" },
        { maxHours: 840, bg: "#4b5563", border: "#6b7280", shadow: "#374151", text: "#e5e7eb" },
      ],
      flippedBg: "#1f2937",
      flippedText: "#e5e7eb",
    },
  ...
  clouds: {
    ...
    node: {
      ...
      ageStops: [
        ...
        { maxHours: 504, bg: "#e2e8f0", border: "#cdcdcd", shadow: "#d7dde6", text: "#475569" },
        { maxHours: 840, bg: "#cbd5e1", border: "#9ca3af", shadow: "#cbd5e1", text: "#475569" },
      ],
      flippedBg: "#f8fafc",
      flippedText: "#1b2538",
    },
